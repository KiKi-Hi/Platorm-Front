const PaymentCompletePage =  () => {
    return (
        <div className="w-96 h-[1206px] relative bg-white overflow-hidden">
            ...
            <div className="w-96 left-0 top-[44px] absolute inline-flex flex-col justify-start items-start">
                ...
                <div className="self-stretch px-5 pt-5 flex flex-col justify-start items-start gap-2.5">
                    <div className="self-stretch pb-7 bg-white border-b-2 border-Line-ExtraHard-15 flex flex-col justify-start items-start gap-1">
                        <div className="self-stretch inline-flex justify-between items-center">
                            <div className="justify-start text-Text-Default-0 text-base font-bold font-['Pretendard'] leading-normal">김이름</div>
                            <div data-icon="false" data-primary="Orange" className="flex justify-start items-center gap-0.5">
                                <div className="text-right justify-start text-Text-Highlight text-xs font-semibold font-['Pretendard'] leading-none">수정하기</div>
                            </div>
                        </div>
                        <div className="justify-start text-Text-Light-1 text-sm font-normal font-['Pretendard'] leading-tight">010-0000-0000</div>
                        <div className="self-stretch justify-start text-Text-Default-0 text-sm font-semibold font-['Pretendard'] leading-tight">ㅇㅇ시 ㅇㅇ구 ㅇㅇㅇㅇ ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ (우편번호)</div>
                    </div>
                </div>
                <div className="w-96 px-5 pt-5 pb-0.5 inline-flex justify-start items-center gap-2.5">
