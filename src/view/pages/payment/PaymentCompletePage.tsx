const PaymentCompletePage = () => {
  return (
    <div className="relative h-[1206px] w-96 overflow-hidden bg-white">
      ...
      <div className="absolute left-0 top-[44px] inline-flex w-96 flex-col items-start justify-start">
        ...
        <div className="flex flex-col items-start justify-start gap-2.5 self-stretch px-5 pt-5">
          <div className="border-Line-ExtraHard-15 flex flex-col items-start justify-start gap-1 self-stretch border-b-2 bg-white pb-7">
            ...
            <div className="text-Text-Default-0 justify-start self-stretch font-['Pretendard'] text-sm font-semibold leading-tight">
              ㅇㅇ시 ㅇㅇ구 ㅇㅇㅇㅇ ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ
              (우편번호)
            </div>
          </div>
        </div>
