...
function HeartIcon({ filled = false, size = 24, color = 'black' }: HeartIconProps) {
  ...
  return filled ? (
    ...
    >
      ...
      <defs>
        <filter id="filter0_d_168_1500" x="-1" y="-1" width="28" height="28" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
